...
{
    public partial class AddLabWorkflowModelAndLabWorkflowCommands : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LabWorkflowId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
                    UpdatedBy = table.Column<decimal>(type: "decimal(20,0)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LabWorkflowCommands_LabWorkflows_LabWorkflowId",
                        column: x => x.LabWorkflowId,
                        principalTable: "LabWorkflows",
                        principalColumn: "Id");
                });

            migrationBuilder.CreateIndex(
                name: "IX_LabWorkflowCommands_LabWorkflowId",
                table: "LabWorkflowCommands",
                column: "LabWorkflowId");
        }
